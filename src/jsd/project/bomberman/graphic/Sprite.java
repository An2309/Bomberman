...
public class Sprite {
    ...
    public static Sprite player_dead = new Sprite(16, 3, 0, SpriteSheet.character, 16, 16);
    ...
    // Power up
    public static Sprite power_bombs = new Sprite(16, 0, 0, SpriteSheet.item, 16, 16);
    public static Sprite power_flames = new Sprite(16, 1, 0, SpriteSheet.item, 16, 16);
    public static Sprite power_speed = new Sprite(16, 2, 0, SpriteSheet.item, 16, 16);
